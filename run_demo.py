...
if __name__=='__main__':
    ...
    # 修改后的默认路径与参数
    parser.add_argument('--mesh_file', type=str, default=f'{code_dir}/demo_data/mustard_0/mesh/textured_simple.obj')
    parser.add_argument('--test_scene_dir', type=str, default=f'{code_dir}/demo_data/mustard_0')
    
    # 降低迭代次数以节省显存和CPU (原值为5和2)
    ...
    if not os.path.exists(args.mesh_file):
        logging.error(f"Mesh file not found: {args.mesh_file}")
        exit()
